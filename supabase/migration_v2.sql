-- Migration: bring DB schema up to date with current code
-- Run this once in the Supabase SQL editor: https://supabase.com/dashboard/project/xkwiugwafgcmcwlyzawq/sql
